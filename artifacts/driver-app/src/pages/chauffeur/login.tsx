      ...
      <div className="w-full max-w-sm">
        ...
        <div className="rounded-2xl border overflow-hidden mb-4" style={{ background: "white", borderColor: BORDER }}>
          ...
          <div className="border-b" style={{ borderColor: BORDER }}>
            <div className="px-4 py-2 flex items-center gap-3" style={{ background: "#FEF6E4" }}>
          ...
          <div>
            <div className="px-4 py-2 flex items-center gap-3" style={{ background: "#FEF6E4" }}>
              <Lock className="h-4 w-4 flex-shrink-0" style={{ color: GOLD }} />
        ...
        {error && (
          <p className="text-center text-sm font-medium mb-4 px-2" style={{ color: GOLD }}>{error}</p>
        )}
